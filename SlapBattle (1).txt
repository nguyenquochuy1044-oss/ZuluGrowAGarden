...
if game.PlaceId == 6403373529 or game.PlaceId == 9015014224 or game.PlaceId == 11520107397 or game.PlaceId == 124596094333302 then
        ...
        Callback = function(Value)
            if Value ~= "" or Value ~= " " then
                ...
                if PlayerTa then
                    ...
                    PlayersCheck:SetText("Player Check [ â ] [ " .. _G.CheckGlovePlayer .. " ]", _G.TimeNotify)
                else
                    PlayersCheck:SetText("Player Check [ â ]", _G.TimeNotify)
                end
            end
        end
    })
    GeneralBadge = InfoServer3Group:AddLabel("General Glove / Badge [ â - " .. (# BadgeSuccess == 0 and "Nah" or # BadgeSuccess) .. " / â - " .. (# BadgeFailure == 0 and "Nah" or # BadgeFailure) .. " ]", true)
    ...
    InfoServer3Group:AddButton({
        ...
        Func = function()
            ...
            GeneralBadge:SetText("General Glove / Badge [ â - " .. (# BadgeSuccess == 0 and "Nah" or # BadgeSuccess) .. " / â - " .. (# BadgeFailure == 0 and "Nah" or # BadgeFailure) .. " ]", true)
            for i, v in pairs(UnlockedGloves:GetChildren()) do
                GloveBadges["Check " .. v.Name]:SetText("Glove [ " .. v.Name .. " - " .. (v.Value == true and "â" or "â") .. " ]", true)
            end
        end
    })
    GloveBadges = {}
    for i, v in pairs(game.Players.LocalPlayer._unlockedGloves:GetChildren()) do
        GloveBadges["Check " .. v.Name] = InfoServer3Group:AddLabel("Glove [ " .. v.Name .. " - " .. (v.Value == true and "â" or "â") .. " ]", true)
    end
    ...
    InfoServer4Group:AddInput("GlovePlayers", {
        ...
        Callback = function(Value)
            ...
            if Glove then
                ...
                TagGlove:SetText("Glove Check [ â ] [ " .. Glove.Name .. " ]", _G.TimeNotify)
            else
                TagGlove:SetText("Glove Check [ â ]", _G.TimeNotify)
            end
        end
    })
                ...
                if v ~= game.Players.LocalPlayer then
                    for i, b in pairs(v._unlockedGloves:GetChildren()) do
                        if b.Name == _G.GlovePlayer and b.Value == true then
                            ...
                            _G.PlayerOwner[# _G.PlayerOwner + 1] = (v.Name == v.DisplayName and " â¢ " .. v.Name or " â¢ " .. v.Name .. " (" .. v.DisplayName .. ")")
    ...
    InfoServer5Group:AddInput("Players", {
        ...
        Callback = function(Value)
            ...
            if PlayerTa then
                ...
                PlayersCheck1:SetText("Player Check [ â ] [ " .. _G.CheckPlayer .. " ]")
            else
                PlayersCheck1:SetText("Player Check [ â ]")
            end
        end
    })
...
task.wait()
            ...
            if game.Players.LocalPlayer.leaderstats.Glove.Value == "Tycoon" then
                while _G.AutoTycoonMastery do
                    if _G.TycoonMastery == "15k Point Die" then
                        if game.Players.LocalPlayer.Character:FindFirstChild("entered") then
                            if game.Workspace:FindFirstChild("ÃTycoon" .. game.Players.LocalPlayer.Name) and game.Workspace["ÃTycoon" .. game.Players.LocalPlayer.Name]:GetAttribute("LastCount") < 15000 then
                                for _, v in pairs(game.Workspace:GetChildren()) do
                                ...
                                elseif game.CoreGui:FindFirstChild("Gui Track").Enabled == true then
                                    game.CoreGui["Gui Track"].Frame:FindFirstChild("TextLabel").Text = "Tycoon Your Point\n" .. game.Workspace:FindFirstChild("ÃTycoon" .. game.Players.LocalPlayer.Name):GetAttribute("LastCount") .. " / 15000"
                                    game.CoreGui["Gui Track"].Frame.Frame:FindFirstChild("Frame1").Size = UDim2.new(game.Workspace:FindFirstChild("ÃTycoon" .. game.Players.LocalPlayer.Name):GetAttribute("LastCount") / 15000, 0, 1, 0)
                                end
                            elseif game.Workspace:FindFirstChild("ÃTycoon" .. game.Players.LocalPlayer.Name) == nil then
                                ...
                                spawn(function()
                                    ...
                                    until (game.Workspace:FindFirstChild("ÃTycoon" .. game.Players.LocalPlayer.Name) and game.Workspace["ÃTycoon" .. game.Players.LocalPlayer.Name]:GetAttribute("LastCount") >= 15000) or (game.Players.LocalPlayer.Character and game.Players.LocalPlayer.Character:FindFirstChild("Humanoid") and game.Players.LocalPlayer.Character:FindFirstChild("Humanoid").Health <= 0)
                                end)
                                wait(1)
                            end
                            if game.Workspace:FindFirstChild("ÃTycoon" .. game.Players.LocalPlayer.Name) and game.Workspace["ÃTycoon" .. game.Players.LocalPlayer.Name]:GetAttribute("LastCount") >= 15000 then
                    ...
                    elseif _G.TycoonMastery:match("Defense Tycoon") then
                        if game.Workspace:FindFirstChild("ÃTycoon" .. game.Players.LocalPlayer.Name) then
                            local Target = nil
                            for i, v in pairs(game.Players:GetChildren()) do
                                if v ~= game.Players.LocalPlayer and game.Players.LocalPlayer.Character:FindFirstChild("HumanoidRootPart") and v.Character and game.Players.LocalPlayer.Character:FindFirstChild("entered") then
                                    if v.Character:FindFirstChild("entered") and v.Character:FindFirstChild("HumanoidRootPart") and v.Character:FindFirstChild("stevebody") == nil and v.Character:FindFirstChild("rock") == nil and v.Character.HumanoidRootPart.BrickColor ~= BrickColor.new("New Yeller") and v.Character.Ragdolled.Value == false and v.Character:FindFirstChild("Mirage") == nil then
                                        if v.Character.Head:FindFirstChild("UnoReverseCard") == nil then
                                            if (v.Character.HumanoidRootPart.Position - game.Workspace:FindFirstChild("ÃTycoon" .. game.Players.LocalPlayer.Name):FindFirstChild("End").Position).Magnitude < 30 then
                                                Target = v.Character
                                            end
                                            if _G.TycoonMastery == "Defense Tycoon (Walk)" then
                                                if (game.Players.LocalPlayer.Character.HumanoidRootPart.Position - game.Workspace:FindFirstChild("ÃTycoon" .. game.Players.LocalPlayer.Name):FindFirstChild("End").Position).Magnitude > 45 then
                            ...
                            if Target then
                                ...
                                if game.Workspace:FindFirstChild("ÃTycoon" .. game.Players.LocalPlayer.Name):FindFirstChild("End") then
                                    if _G.TycoonMastery == "Defense Tycoon (Walk)" then
                                        game.Players.LocalPlayer.Character.Humanoid:MoveTo(game.Workspace:FindFirstChild("ÃTycoon" .. game.Players.LocalPlayer.Name):FindFirstChild("End").Position)
                                    elseif _G.TycoonMastery == "Defense Tycoon (TP)" then
                                        game.Players.LocalPlayer.Character:SetPrimaryPartCFrame(game.Workspace:FindFirstChild("ÃTycoon" .. game.Players.LocalPlayer.Name):FindFirstChild("End").CFrame)
                                    end
                                end
                            end
                        end
                    elseif _G.TycoonMastery == "Kill Player (Tycoon God)" then
                        if game.Players.LocalPlayer.Character:FindFirstChild("entered") then
                            if game.Workspace:FindFirstChild("ÃTycoon" .. game.Players.LocalPlayer.Name) and game.Workspace["ÃTycoon" .. game.Players.LocalPlayer.Name]:GetAttribute("LastCount") < 5000 then
                                for _, v in pairs(game.Workspace:GetChildren()) do
                                    if v.Name:match(game.Players.LocalPlayer.Name) then
                                        for i, x in pairs(v:GetChildren()) do
                                            if x.Name == "TycoonDrop" then
                                ...
                                if game.CoreGui:FindFirstChild("Gui Track").Enabled == false then
                                    game.CoreGui["Gui Track"].Enabled = true
                                elseif game.CoreGui:FindFirstChild("Gui Track").Enabled == true then
                                    game.CoreGui["Gui Track"].Frame:FindFirstChild("TextLabel").Text = "Tycoon Your Point\n" .. game.Workspace:FindFirstChild("ÃTycoon" .. game.Players.LocalPlayer.Name):GetAttribute("LastCount") .. " / 5000"
                                    game.CoreGui["Gui Track"].Frame.Frame:FindFirstChild("Frame1").Size = UDim2.new(game.Workspace:FindFirstChild("ÃTycoon" .. game.Players.LocalPlayer.Name):GetAttribute("LastCount") / 5000, 0, 1, 0)
                                end
                            elseif game.Workspace:FindFirstChild("ÃTycoon" .. game.Players.LocalPlayer.Name) == nil then
                                game:GetService("ReplicatedStorage"):WaitForChild("GeneralAbility"):FireServer(CFrame.new(17894, - 26.257728576660156, - 3579.11279296875, 0.9996822476387024, - 1.1041408759515647e-10, 0.02520809881389141, 2.8899729831444176e-10, 1, - 7.080715569429685e-09, - 0.02520809881389141, 7.085750652890965e-09, 0.9996822476387024))
                                spawn(function()
                                    repeat
                                        task.wait()
                                        game.Players.LocalPlayer.Character:SetPrimaryPartCFrame(workspace["SafeBox"].CFrame * CFrame.new(0, 5, 0))
                                    until (game.Workspace:FindFirstChild("ÃTycoon" .. game.Players.LocalPlayer.Name) and game.Workspace["ÃTycoon" .. game.Players.LocalPlayer.Name]:GetAttribute("LastCount") >= 5000) or (game.Players.LocalPlayer.Character and game.Players.LocalPlayer.Character:FindFirstChild("Humanoid") and game.Players.LocalPlayer.Character:FindFirstChild("Humanoid").Health <= 0)
                                end)
                                wait(1)
                            end
                            if game.Workspace:FindFirstChild("ÃTycoon" .. game.Players.LocalPlayer.Name) and game.Workspace["ÃTycoon" .. game.Players.LocalPlayer.Name]:GetAttribute("LastCount") >= 5000 then
                ...
                while _G.AutoShardMastery do
                    ...
                    elseif _G.ShardMastery == "Get Slap" then
                        if game.Players.LocalPlayer.Character:FindFirstChild("HumanoidRootPart") then
                            ...
                            game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = workspace["SafeBox"].CFrame * CFrame.new(0, 5, 0)
                            for i, v in pairs(game.Workspace:GetChildren()) do
                                if v.Name == ("Ã" .. game.Players.LocalPlayer.Name) and v:FindFirstChild("HumanoidRootPart") then
                                    repeat
                                        task.wait()
            ...
            if game.Players.LocalPlayer.leaderstats.Glove.Value == "Bomb" then
                while _G.AutoBombMastery do
                    ...
                    elseif _G.BombMastery == "Snipe Bomb + Void" then
                        ...
                        until game.Workspace:FindFirstChild(game.Players.LocalPlayer.Name .. "_bÃ¸mb")
                        wait(0.5)
                        repeat
                            task.wait()
                            if game.Players.LocalPlayer.Character:FindFirstChild("HumanoidRootPart") and game.Workspace:FindFirstChild(game.Players.LocalPlayer.Name .. "_bÃ¸mb") then
                                game.Players.LocalPlayer.Character:SetPrimaryPartCFrame(game.Workspace:FindFirstChild(game.Players.LocalPlayer.Name .. "_bÃ¸mb").CFrame)
                            end
                        until game.Workspace:FindFirstChild(game.Players.LocalPlayer.Name .. "_bÃ¸mb") == nil
                        task.wait(0.75)
                        repeat
                            task.wait()
                            game.Players.LocalPlayer.Character:SetPrimaryPartCFrame(game.Workspace.DEATHBARRIER.CFrame)
    ...
    Misc1Basic:AddToggle("Auto Spam Ability", {
        ...
        Callback = function(Value)
            ...
            while _G.OnAbility and game.Players.LocalPlayer.leaderstats.Glove.Value == "ð¿" do
...
elseif game.PlaceId == 11828384869 then
    local Window = Library:CreateWindow({
        Title = "Omega X Article Hub - Maze ðï¸p",
        Center = true,
        AutoShow = true,
        Resizable = true,
        AutoLock = true,
